...
В нашей отрасли инструменты и подходы устаревают достаточно быстро, поэтому гораздо важнее ваша способность обучиться новому, чем знание зачем нужен третий аргумент в функции `strcmp`. 
...
- [Скобки](https://github.com/PINALLPINKIT/intern-php-developer/blob/master/task01-brackets.md) — реализовать самый простой алгоритм для дальнейшего переиспользования
- [Форма обратной связи](https://github.com/PINALLPINKIT/intern-php-developer/blob/master/task02-feedback-form.md) — очередная форма заявки для сайта
- [Книги](https://github.com/PINALLPINKIT/intern-php-developer/blob/master/task03-books.md) — иногда вам придётся писать SQL-код
